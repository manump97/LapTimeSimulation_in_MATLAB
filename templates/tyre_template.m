...
tyre.p_exp = 0.4; % [] Pressure exponent 0.3
tyre.Fz0 = 15000; % [N] Maximum load Fz
tyre.Fz_exp = 0.9; % [] Load Fz exponent 0.85
tyre.v0 = 0.03; % [] Speed term 0 0.018
tyre.v1 = 6e-4; % [] Speed term 1 6e-5
...
% V = (c14*Fz^2+c15*Fz)*camber+c16*Fz+c17;
...
while i <= length(vxs)
    ...
    xticks([0:1000:15000]);yticks([0:250:1500])
    i = i+1;
end
